...
<div class="modal-overlay-premium" id="dateModal">
    <div class="modal-content-premium">
        ...
        <div style="padding: var(--spacing-lg);">
            <div style="background: rgba(59, 130, 246, 0.08); border: 1px solid rgba(59, 130, 246, 0.15); border-radius: 10px; padding: 1rem; margin-bottom: 2rem; display: flex; align-items: flex-start; gap: 0.75rem;">
